    ...
    <div className={`border-t border-gray-200 p-4 ${className}`}>
      <div className="flex items-end gap-2">
        <textarea
          ...
          disabled={isDisabled}
          rows={1}
          className="flex-1 resize-none rounded-lg border border-gray-300 bg-white px-3 text-black py-2 text-sm focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 disabled:bg-gray-100"
